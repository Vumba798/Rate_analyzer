package com.example.rateanalyzer.rateanalyzer
...
class RateAnalyzer {
    ...
    suspend fun saveToFile(file: FileOutputStream) = withContext(Dispatchers.IO){
        file.bufferedWriter().write(jsonString)
    }
